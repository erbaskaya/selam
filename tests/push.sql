...
insert into auth.users(id,email) values('00000000-0000-0000-0000-000000000001','a@push.invalid'),('00000000-0000-0000-0000-000000000002','b@push.invalid'),('00000000-0000-0000-0000-000000000003','e@push.invalid');
...
insert into public.conversation_members(conversation_id,user_id,role) values('10000000-0000-0000-0000-000000000001','00000000-0000-0000-0000-000000000001','member'),('10000000-0000-0000-0000-000000000001','00000000-0000-0000-0000-000000000002','member');
...
select public.test_assert(:'claimed'::jsonb->>'user_id'='00000000-0000-0000-0000-000000000002','worker receives actual recipient');
...
reset role;
insert into public.conversation_user_states(conversation_id,user_id,muted_until) values('10000000-0000-0000-0000-000000000001','00000000-0000-0000-0000-000000000002',now()+interval '1 day');
set local role authenticated;
select set_config('request.jwt.claim.sub','00000000-0000-0000-0000-000000000002',true);
...
insert into public.user_settings(user_id,notifications_enabled) values('00000000-0000-0000-0000-000000000002',false);
set local role authenticated;
select set_config('request.jwt.claim.sub','00000000-0000-0000-0000-000000000002',true);
